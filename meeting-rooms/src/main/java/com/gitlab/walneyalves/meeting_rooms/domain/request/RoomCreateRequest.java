...
public record RoomCreateRequest(@NonNull String name,
                                @NonNull Integer capacity,
                                @NonNull @JsonFormat(pattern = "HH:mm:ss") @Schema(type = "string", format = "HH:mm:ss") LocalTime initialAvailability,
